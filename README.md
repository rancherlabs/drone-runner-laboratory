...
* Latest - v2.5.8 - `rancher/rancher:latest` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.5.8).

* Stable - v2.5.8 - `rancher/rancher:stable` - Read the full release [notes](https://github.com/rancher/rancher/releases/tag/v2.5.8).
...
>>>>>>> d60543a03cdaf53e0bb497478b7426664e1b29ae
